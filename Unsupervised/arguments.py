...
def arg_parse():
    ...
    parser.add_argument('--dataname', dest='dataname', type=str, default='FMRI', help='Dataname')
    ...
    parser.add_argument('--data_root', type=str, default='./pyg_data', help='Path to the dataset directory')
